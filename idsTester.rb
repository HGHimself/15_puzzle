...
goal_input   = ARGV[1] # or set this to a string with your own goal
goal_val = PuzzleNode.parse_state(goal_input, true)

initial_string = ARGV[0] #or set this to one of the difficulties defined above

s0                   = PuzzleNode.parse_state(initial_string)
...
searchStrategy = DepthLimitedSearcher.new(s0, goal_node, :generate_states, 4, 1)
startTime = Time.now
solution = searchStrategy.search
